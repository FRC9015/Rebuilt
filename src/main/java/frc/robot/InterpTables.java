...
public class InterpTables {
  ...
  public InterpTables() {
    ...
    shooterSpeedHubInterp.put(2.0, 31.0); // good
    ...
    shooterSpeedHubInterp.put(3.5, 38.0);
    shooterSpeedHubInterp.put(4.0, 43.0);
    shooterSpeedHubInterp.put(4.5, 46.0);
    shooterSpeedHubInterp.put(5.0, 46.0);
    ...
    hoodAngleHubInterp.put(3.0, 0.26);
    hoodAngleHubInterp.put(3.5, 0.315);
    hoodAngleHubInterp.put(4.0, 0.355);
    hoodAngleHubInterp.put(4.5, 0.41);
    hoodAngleHubInterp.put(5.0, 0.445);
