...
public enum StateEnum {
  ...
  ENDGAME,
  /**
   * for when robot is being practiced or tested outside of a certain state; to use set time to -1
   * (default in ds gui)
   */
  PRACTICE,
  /**
   * when the robot is not set to anything in particular or the winner of auto is unknown but needed
   * information
   */
  UNKNOWN
}
